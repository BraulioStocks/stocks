...
st.title("📈 Stock Trend Predictor (XGBoost + Backtest + Insights)")
...
# === Backtest with Strategy vs Buy & Hold ===
st.subheader("💰 Strategy Backtest (Model vs Buy & Hold)")
...
st.subheader("📌 Trade Signals on Price Chart")
