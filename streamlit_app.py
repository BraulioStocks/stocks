...
apikey     = st.text_input(t2QaKaEK7z4WnLBnj7EiyWy1ViDoaEY9, type="password")
...
with st.expander("📊 Annual Valuation Metrics (via FMP API)"):
    if not apikey:
        st.info("Enter your FinancialModelingPrep API key to load annual valuation charts.")
    else:
        try:
            # 1) Fetch 5 years of income statements
            url_inc = (
            ...
            # ensure we have earnings & revenue
            ...
            # 2) Fetch 5 years of balance sheet statements
            url_bs   = (
